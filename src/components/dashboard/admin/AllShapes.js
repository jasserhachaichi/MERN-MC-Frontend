    ...
    useEffect(() => {
                ...
                <div className="symbol rounded-0 symbol-50px overflow-hidden me-3">
                  <a href="#">
                    <div className="symbol-label">
                      <img src={`https://mern-material-cutting.onrender.com/product/image/shape/${row.original.avatarShapeImg}` || '/assets/images/Default-profile.jpg'} alt={row.original.shapeName} className="w-100" />
                    </div>
                  </a>
                </div>
              </td>
      ...
      const handleDelete = async (userId) => {
        ...
        if (result.isConfirmed) {
          try {
            await axios.delete(`https://mern-material-cutting.onrender.com/product/deleteshape/${userId}`, { withCredentials: true });
